            ...
            <div className="container mx-auto px-4">
                ...
                <div className="block md:hidden w-full">
                    ...
                    <div 
                        ...
                        } transition-transform duration-300 ease-in-out z-50 max-w-full`}
                    >
                        {/* Close button */}
                        ...
                        <div className="h-[calc(100vh-60px)] overflow-y-auto">
                            ...
                            <div className="p-4">
                                ...
                                <div className="space-y-2">
                                    {categories.map((category, index) => (
                                        <div key={index} className="flex items-center justify-between py-2 hover:text-[#3bb77e] cursor-pointer">
                                            <div className="flex items-center gap-3">
                                                <img src={category.icon} alt={category.name} className="w-7 h-7 object-contain" />
                            ...
                            <div className="p-4 border-t">
                                <h2 className="text-lg font-semibold mb-4">Fill by price</h2>
                                <div className="space-y-4">
                                    ...
                                    <input
                                        type="range"
                                        className="w-full h-1.5 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-[#3bb77e]"
                                    />
                                </div>
                            </div>
                            ...
                            {/* Item Condition */}
                            <div className="p-4 border-t">
                                <h2 className="text-lg font-semibold mb-4">Item Condition</h2>
                                <div className="space-y-2">
                                    <div className="flex items-center gap-2">
                                        <input type="checkbox" className="accent-[#3bb77e]" />
                                        <span className="text-sm text-gray-600">New (15)</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <input type="checkbox" className="accent-[#3bb77e]" />
                                        <span className="text-sm text-gray-600">Refurbished (7)</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <input type="checkbox" className="accent-[#3bb77e]" />
                                        <span className="text-sm text-gray-600">Used (45)</span>
                                    </div>
                                </div>
                            </div>
                        </div>
